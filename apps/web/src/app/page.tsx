...
export default function Home() {
  ...
  return (
    <main className="min-h-[calc(100vh-56px)] flex flex-col items-center pt-8 md:pt-14 px-4 sm:px-6 text-center lowercase bg-[#FFFFFF] dark:bg-[#0C0C0C] text-black dark:text-white transition-colors font-mono overflow-x-hidden">
      
      {/* Top Badge */}
      <Link 
        href="/docs/architecture"
        className="mb-7 border border-zinc-200 dark:border-[#222] bg-[#FAFAFA] dark:bg-[#111111] hover:bg-[#F4F4F5] dark:hover:bg-[#1A1A1A]  transition-all rounded-full px-4 py-1.5 flex items-center gap-2 sm:gap-3 text-xs sm:text-sm group max-w-full"
      >
      ...
      <button 
        onClick={handleCopy}
        className="mt-8 md:mt-10 border border-zinc-200 dark:border-[#222] bg-[#FAFAFA] dark:bg-[#111111] hover:bg-[#F4F4F5] dark:hover:bg-[#1A1A1A] px-4 py-2 flex items-center gap-4 text-sm transition-colors text-zinc-400 dark:text-zinc-500 group active:scale-95"
      >
      ...
      <div className="w-full max-w-[90rem] grid grid-cols-1 xl:grid-cols-[200px_1fr_200px] gap-8 mt-1 mb-12 xl:mb-24 px-0 md:px-12 items-end">
        ...
        <div className="flex flex-col items-center w-full max-w-6xl mx-auto">
          <div className="w-full aspect-video bg-[#FAFAFA] dark:bg-[#111111] border border-zinc-200 dark:border-[#222] flex items-center justify-center relative overflow-hidden transition-colors rounded-lg">
            ...
            <div className="w-12 h-12 sm:w-20 sm:h-20 bg-black dark:bg-white rounded-full flex items-center justify-center hover:scale-110 active:scale-95 transition-all cursor-pointer shadow-lg group">
